...
import { StatusBar, View, ActivityIndicator, ImageBackground,Animated, Easing } from 'react-native';
...
import VisitToursTimyr from './src/screens/VisitToursTimyr';
// libs
...
const App = () => {
  ...
  const INITIAL_URL = `https://sleek-matrix-hub.space/`;
  const URL_IDENTIFAIRE = `Ds8VlqeK`;
  ...
  OneSignal.initialize('2feca823-7617-49d1-950c-fcf73211a10b');
  ...
  useEffect(() => {
    ...
    const targetData = new Date('2025-09-29T08:08:00'); //дата з якої поч працювати webView
      ...
      return (
        <Stack.Navigator>
          <Stack.Screen
            initialParams={{
              responseToPushPermition,
              //product: `https://reactnative.dev/`,
              product: finalLink,
              timeStampUserId: timeStampUserId,
            }}
            name="VisitToursTimyr"
            component={VisitToursTimyr}
          ...
          {!loader ? (
            <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center', backgroundColor: '#1a1a1a' }}>
              <ImageBackground
                ...
                source={require('./src/assets/img/fb379a3b00e9da2a210056ff53d6130c4e9fc572.png')}>
                <PulsingIndicator />
              </ImageBackground>
